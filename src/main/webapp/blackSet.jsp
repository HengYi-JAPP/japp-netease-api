    ...
    <div class="container-fluid">
        <div class="collapse navbar-collapse">
            <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="blackSet.jsp">黑名单</a></li>
...
<div id='uploader-black-set' class="uploader" data-ride="uploader" data-url="your/file/upload/url">
    <button type="button" class="btn btn-primary uploader-btn-browse">
        <i class="icon icon-cloud-upload"></i> 上传黑名单
    </button>
</div>
